...
export default {
  ...
  setup() {
    ...
    watch(stationStore, async (newStore) => {
...
<template>
  ...
  <ul className="journeys bg-slate-300 font-bold text-black">
    <li className="grid grid-cols-10 p-2 border-b">
      ...
      <TableHeader
        ...
        label="Start station"
        :ordering="orderString"
        :active="p.orderby === 'departure_station_name'"
      ...
      <TableHeader
        ...
        label="End station"
        :ordering="orderString"
        :active="p.orderby === 'return_station_name'"
        :className="['text-left', 'col-span-2', 'cursor-pointer']"
      />
      <TableHeader
        :clickFn="
        ...
        label="Start date"
        :ordering="orderString"
        :active="p.orderby === 'departuredate'"
  ...
  <ul className="stations">
    <JourneyItemVue
      ...
      :journey="journey"
      :index="i + 1 + p.offset"
      :active="state.active === journey.id.toString() || journeys.length === 1"
      :setActive="(id: string) =>
